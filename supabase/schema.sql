...
-- =============================================
-- MEETING REMINDER DELIVERIES (IDEMPOTENCY + AUDIT)
-- =============================================
...
CREATE INDEX IF NOT EXISTS idx_meeting_reminder_deliveries_date ON meeting_reminder_deliveries(reminder_date DESC);
CREATE INDEX IF NOT EXISTS idx_meeting_reminder_deliveries_meeting ON meeting_reminder_deliveries(meeting_id);
CREATE INDEX IF NOT EXISTS idx_meeting_reminder_deliveries_recipient ON meeting_reminder_deliveries(recipient_email);

-- =============================================
-- CONTRIBUTION REMINDER DELIVERIES (THROTTLING + AUDIT)
-- =============================================
...
CREATE INDEX IF NOT EXISTS idx_contribution_reminder_deliveries_date ON contribution_reminder_deliveries(reminder_date DESC);
CREATE INDEX IF NOT EXISTS idx_contribution_reminder_deliveries_member ON contribution_reminder_deliveries(member_id);
CREATE INDEX IF NOT EXISTS idx_contribution_reminder_deliveries_recipient ON contribution_reminder_deliveries(recipient_email);
