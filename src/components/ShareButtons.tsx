...
import { shareEvent } from "@/lib/exportUtils";
...
export function ShareButtons({
  ...
  const handleShare = (platform: "whatsapp" | "facebook" | "twitter" | "copy") => {
    const copied = shareEvent(title, description, url, platform);
    if (copied) {
      toast({
        title: "Link Copied!",
    ...
    return (
      <div className="flex gap-2">
        ...
        <Button
          ...
          className="flex-1 border-foreground/30 hover:bg-foreground/10"
        >
          <TwitterIcon />
