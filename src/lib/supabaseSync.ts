...
const SYNC_CONFIG: Record<string, TableConfig> = {
  ...
  choir_meeting_minutes: {
    ...
    toDb: (m: any) => ({
      ...
      google_meet_link: m.googleMeetLink || null,
      google_event_link: m.googleEventLink || null,
      google_conference_id: m.googleConferenceId || null,
    ...
    fromDb: (r: any) => ({
      ...
      googleEventLink: r.google_event_link || '',
      googleConferenceId: r.google_conference_id || '',
      attachments: [],
      createdAt: r.created_at,
      updatedAt: r.updated_at,
    }),
  ...
  choir_contributions: {
    ...
    toDb: (c: any) => ({
      ...
      notes: c.notes || null,
      class_at_payment: c.classAtPayment || null,
    ...
    fromDb: (r: any) => ({
      ...
      reference: r.reference || '',
      notes: r.notes || '',
      classAtPayment: r.class_at_payment || undefined,
      recordedBy: r.recorded_by || '',
      createdAt: r.created_at,
    }),
  },

  // --- Member Class Changes ---
  choir_member_class_changes: {
    table: 'member_class_changes',
    orderBy: 'changed_at',
    orderAsc: false,
    toDb: (c: any) => ({
      id: c.id,
      member_id: c.memberId,
      old_class: c.oldClass || null,
      new_class: c.newClass || null,
      changed_by_admin_id: c.changedByAdminId || null,
      changed_by_name: c.changedByName || null,
      changed_by_role: c.changedByRole || null,
      reason: c.reason || null,
      changed_at: c.changedAt || new Date().toISOString(),
    }),
    fromDb: (r: any) => ({
      id: r.id,
      memberId: r.member_id,
      oldClass: r.old_class || undefined,
      newClass: r.new_class || undefined,
  ...
  choir_special_contribution_assignments: {
    table: 'special_contribution_assignments',
    orderBy: 'assigned_at',
    orderAsc: false,
    toDb: (a: any) => ({
      id: a.id,
      type_id: a.typeId,
      member_id: a.memberId,
      class_at_assignment: a.classAtAssignment || null,
      expected_amount: a.expectedAmount || 0,
      assignment_source: a.assignmentSource || 'type_created',
      assigned_at: a.assignedAt || new Date().toISOString(),
    }),
    fromDb: (r: any) => ({
      id: r.id,
      typeId: r.type_id,
      memberId: r.member_id,
      classAtAssignment: r.class_at_assignment || undefined,
      expectedAmount: Number(r.expected_amount) || 0,
      assignmentSource: r.assignment_source || 'type_created',
      assignedAt: r.assigned_at,
    }),
  },
  ...
  choir_contribution_types: {
    ...
    toDb: (t: any) => ({
      ...
      amount: t.amount || 0,
      special_amount_mode: t.specialAmountMode || 'flat_per_member',
      class_1_amount: t.class1Amount || null,
      class_2_amount: t.class2Amount || null,
      class_3_amount: t.class3Amount || null,
    ...
    fromDb: (r: any) => ({
      ...
      specialAmountMode: r.special_amount_mode || 'flat_per_member',
      class1Amount: r.class_1_amount ? Number(r.class_1_amount) : undefined,
      class2Amount: r.class_2_amount ? Number(r.class_2_amount) : undefined,
      class3Amount: r.class_3_amount ? Number(r.class_3_amount) : undefined,
      description: r.description || '',
  ...
  serenades_members: {
    ...
    toDb: (m: any) => ({
      ...
      phone: m.phone || null,
      voice: m.voice,
      special_contribution_class: m.specialContributionClass || null,
    ...
    fromDb: (r: any) => ({
      ...
      phone: r.phone || '',
      voice: r.voice,
      specialContributionClass: r.special_contribution_class || undefined,
      status: r.status || 'Pending',
